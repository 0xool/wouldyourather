...
class QuestionBox extends Component {
    ...
    render () {
        return(
                ...
                <div className='Question-box-second-section'><input type="text" style={{width:'80%', textAlign:'center',backgroundColor:'#2467e2',place:'white',borderColor:'#2467e2',color:'white',border:'none'}} placeholder={this.state.initialSecondQusetion} onChange={this.onSecondQuestionEdit} onSelect={this.onSecondQuestionEdit}/></div>
                <div className='Question-box-first-section'><input type="text" style={{width:'80%', textAlign:'center',backgroundColor:'#d42222',place:'white',borderColor:'#d42222',color:'white',border:'none'}} placeholder={this.state.initialFirstQusetion} onChange={this.onFirstQuestionEdit} onSelect={this.onFirstQuestionEdit}/></div>
